...
class registrationThread (threading.Thread):
    def __init__(self, indexPerProc,processNr,rec,dataSmall,dataSmallOriginal,totMovement,cols, rows, height,angleStep,crop, mycent):
        threading.Thread.__init__(self)
	#print 'current thread id ',threading.current_thread().ident
        #self.threadID = threadID
	...
	self.crop=crop
	self.mycent=mycent
	self.totMovement=totMovement
	self.dataSmallOriginal=dataSmallOriginal
    def run(self):
	threadLimiter.acquire()
	try:
